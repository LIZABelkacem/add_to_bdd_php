            ...
            if(filter_var($mail, FILTER_VALIDATE_EMAIL)) {
               ...
               if($mailexist == 0) {
                  if($mdp == $mdp2) {
                     ...
                     $insertmbr = $bdd->prepare("INSERT INTO user(pseudo, mail, motdepasse, confirmKey ) VALUES(?, ?, ?, ?)");
                     ...
                     $erreur  = "Le compte a bien été créé ! <a href=\"connexion.php\">Me connecter</a>";
                  } else {
         ...
         <form method="POST" action=""  class = "form" >
            <table>
               <tr>
                  ...
                  <td>
                     <input type="text" placeholder="Le pseudo" id="pseudo" name="pseudo" value="<?php if(isset($pseudo)) { echo $pseudo; } ?>" />
                  </td>
               </tr>
               <tr>
                  <td align="right">
                  ...
                  <td>
                     <input type="email" placeholder="Le mail" id="mail" name="mail" value="<?php if(isset($mail)) { echo $mail; } ?>" />
                  </td>
               </tr>
               <tr>
                  <td align="right">
                  ...
                  <td>
                     <input type="email" placeholder="Confirmez le mail" id="mail2" name="mail2" value="<?php if(isset($mail2)) { echo $mail2; } ?>" />
                  </td>
               </tr>
               <tr>
                  <td align="right">
               ...
               <tr>
                  ...
                  <td align="center">
                     <br />
                     <input type="submit" class="lol" name="forminscription" value="Ajout" />
                  </td>
               </tr>
            </table>
         </form>
