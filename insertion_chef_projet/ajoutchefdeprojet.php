      ...
      if($pseudolength <= 255) {
         if($mail == $mail2) {
            if(filter_var($mail, FILTER_VALIDATE_EMAIL)) {
               $reqmail = $bdd->prepare("SELECT* FROM chef_projet WHERE mail = ?");
               ...
               if($mailexist == 0) {
                  if($mdp == $mdp2) {
                     ...
                     $insertmbr = $bdd->prepare("INSERT INTO chef_projet(pseudo, mail, motdepasse) VALUES(?, ?, ?)");
...
<h1> Ajout d'un chef de projet</h1>
